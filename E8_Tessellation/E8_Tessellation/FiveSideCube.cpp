...
FiveSideCube::FiveSideCube(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int lresolution)
{
...
void FiveSideCube::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
	...
	vertexCount = ((6 * resolution)*resolution) * 5;
